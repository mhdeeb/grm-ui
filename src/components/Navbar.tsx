...
import { Flex, Spacer, Image, Heading, useStyleConfig, Center, VStack, Tooltip, useDisclosure, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, Button } from '@chakra-ui/react';
        ...
        <>
            <Modal isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                    ...
                    <ModalCloseButton />
                    <ModalBody>
                        GRM (Genomic Resistance Mapping) is a web application that provides a platform for data collection,
                        preprocessing, analysis, and machine learning. It is designed to be user-friendly and easy to use.
                        GRM frontend is built using React and Chakra UI. The backend is built using using Python.
                        GRM is open-source and free to use. For more information, visit the GitHub repository.
                        <br />
                        <br />
                        <Link to="https://github.com/editnori/Genomic-Resistance-Mapping-GRM-">GitHub</Link>
                    </ModalBody>
                    <ModalFooter>
